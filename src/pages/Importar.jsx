    ...
    <div className="space-y-4">
      {step === 'upload' && (
        <div className="space-y-4">
          ...
          <div
            className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-colors ${dragging ? 'border-emerald-400 bg-emerald-50' : 'border-slate-200 hover:border-emerald-400 hover:bg-emerald-50'}`}
